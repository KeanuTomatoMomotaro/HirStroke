...
//start session
session_start();
//echo $_SESSION['practiceIndex']; for debugging purposes
...
//get Data
$query = "SELECT `index`, `alphabetName`, `strokeNumb`, `alphaUrl`, `noUrl`, `strokesUrl` FROM `alphabet` WHERE `index` = ".$_SESSION['practiceIndex'].";";
...
$_SESSION['oldPracticeIndex'] = $_SESSION['practiceIndex'];
?>
<!DOCTYPE html>
<html>
<head>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Exercise <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Lets do some exercise!</h4>
            </div>
            <div class="modal-body">
                <p>Now its time for you to be active,</p>
...
<!--                    <button type="button" class="btn btn-default btn-lg"><a href="LearningServlet.php?back=true"><i class="glyphicon glyphicon-chevron-left"></i></a></button>-->
                ...
                <div class="col-xs-4 col-md-4">
<!--                    <a href="ControlledPracticeServlet.php"><button type="button" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-chevron-right"></i></button></a>-->
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="col-xs-3 col-md-3">
                    <div class="btn-group btn-group-justified" role="group" aria-label="...">
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default" id="Button <?php echo $buttonOrder;?>" onclick="validateStrokeControlled(<?php echo $buttonOrder;?>,<?php echo $strokeNumb;?>,'alertSuccess','Button <?php echo $buttonOrder;?>','successModal')"><img class="img-responsive center-block" src="<?php echo $strokeOrderExploded[$i];?>" alt="HiraganaOrder" ></button>
                        </div>
                    </div>
                </div>
                <?php
            ...
            elseif($strokeNumb=="1"){
                ...
                for($i=0;$i<sizeof($strokeOrderExploded);$i++){//get order from url file
                    $buttonOrder=substr($strokeOrderExploded[$i],-5,1);
                    ?>
